...
// Nightly defines GIT_COMMIT and GIT_BRANCH in GH Actions
	...
	#define FILE_DESCRIPTION "YR-Spawner, Ares-compatible YR engine extension"
	...
	#define FILE_DESCRIPTION "Unstable nightly devbuild of YR-Spawner engine extension"
	...
	#define SAVEGAME_ID ((BUILD_NUMBER << 24) | (BUILD_NUMBER << 12) | (BUILD_NUMBER))
	#define FILE_DESCRIPTION "Development build of YR-Spawner engine extension"
